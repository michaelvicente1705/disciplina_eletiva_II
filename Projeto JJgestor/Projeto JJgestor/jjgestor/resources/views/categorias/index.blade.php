                    ...
                    <div class="flex items-center mt-4 mb-10">
                        ...
                        <form action="{{route('produto.search')}}" method="get">
                            <div class="flex">
                                ...
                                <input name="pesquisa" class="w-full rounded p-2" type="text" placeholder="Pesquise o Produto...">
                                <button class="px-5  border-black border text-black rounded transition duration-300
                                        hover:bg-black hover:text-white focus:outline-none" type="submit">Pesquisar  <i class="fas fa-search"></i></button>
                            </div>
                        </form>
                        ...
                        <div>
                            ...
                            <table class="table-auto min-w-full">
                                ...
                                @foreach($categoria as $item)
                                    ...
                                    hover:bg-blue-700 hover:text-white focus:outline-none" href="{{route('categoria.edit', $item->id)}}"><i class="far fa-edit"></i> Alterar</a>

                                            <a class="px-5 py-2 border-red-500 border text-red-500 rounded transition duration-300
                                    hover:bg-red-700 hover:text-white focus:outline-none" href="{{ route('categorias.delete', $item->id)}}" ><i class="far fa-trash-alt"></i> Excluir</a>
                                        </td>
                                    <tr>
                                @endforeach
